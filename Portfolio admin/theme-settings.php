...
<html lang="en">
    <head>
        ...
        <title>Theme Settings - Portfolio admin</title>
						...
						<div class="col-md-8 offset-md-2">
							...
							<form>
								<div class="form-group row">
									...
									<div class="col-lg-9">
										<input name="website_name" class="form-control" value="Shakthi Technologies" type="text">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-2">
										<div class="img-thumbnail float-right"><img src="assets/img/logo 2.svg" alt="" width="80" height="50"></div>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-2">
										<div class="settings-image img-thumbnail float-right"><img src="assets/img/logo.svg" class="img-fluid" width="50" height="30" alt=""></div>
									</div>
								</div>
