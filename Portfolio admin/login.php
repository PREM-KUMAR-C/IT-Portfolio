        ...
        <div class="account-content">
            <div class="container">
                ...
                <div class="account-logo">
                    <a href="index.php"><img src="assets/img/logo 2.svg" alt="Company Logo"></a>
                </div>
                <!-- /Account Logo -->
                    ...
                    <div class="account-wrapper">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="account-footer">
                                <p>Having Trouble? report an issue <a target="https://github.com/"
                                        href="https://github.com/"> Here</a></p>
                            </div>
                        </form>
                        <!-- /Account Form -->
