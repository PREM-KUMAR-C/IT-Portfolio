                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="ClientId" readonly type="text" value="<?php echo 'CLT-'.$id; ?>"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="client_edit.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="col-form-label">Client ID <span class="text-danger">*</span></label>
                                    <input name="ClientId" readonly type="text" class="form-control"
...
<div class="modal custom-modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"> Cancel</button>
                <a href="client_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"> Yes</a>
            </div>
        </div>
    </div>
</div>