...
<head>
    ...
    <title>Resignation - Portfolio admin</title>
...
<body>
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            <a href="#addnew" data-toggle="modal" class="btn add-btn">+ Add Resignation</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                        ...
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped custom-table mb-0 datatable">
                                ...
                                <tbody>
                                    ...
                                    <?php include('resign_add_edit_delete_modal.php'); $cnt=$cnt+1;
									}
									?>
                                </tbody>
                            </table>
    ...
    <?php include('resign_add_edit_delete_modal.php') ?>
    </div>
