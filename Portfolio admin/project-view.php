...
<?php
	...
	$sql="select * from projects where id=:invid";
...
<head>
    ...
    <title>Project View - Portfolio admin</title>
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title"><?php echo  htmlentities($row->Project_name);?></h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto float-right ml-auto">
                            ...
                            <a href="task-board.php" class="btn btn-white float-right m-r-10" data-toggle="tooltip"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="project-title">
                                    <h5 class="card-title"><?php echo  htmlentities($row->Project_name);?></h5>
                                ...
                                <p><?php echo  htmlentities($row->Description);?><br>Lorem ipsum dolor sit amet,
                                    consectetur adipiscing elit. Donec vel elit neque. Class
                                    ...
                                    <li>
                                        <div class="files-cont">
                                            ...
                                            <div class="files-info">
                                                ...
                                                <span class="file-author"><a href="#">Arjun</a></span> <span
                                    ...
                                    <li>
                                        <div class="files-cont">
                                            ...
                                            <div class="files-info">
                                                <span class="file-name text-ellipsis"><a href="#">AHA Selfcare Mobile
                                                        Application Test-Cases.xls</a></span>
                                                <span class="file-author"><a href="#">Sukarna</a></span> <span
                                                    class="file-date">May 31st at 6:53 PM</span>
                                                <div class="file-size">Size: 14.8Mb</div>
                                            </div>
                                            <ul class="files-action">
                                ...
                                <table class="table table-striped table-border">
                                    <tbody>
                                        <tr>
                                            <td>Cost:</td>
                                            <td class="text-right">
                                                <?php echo  htmlentities($row->Project_cost);?></td>
                                        </tr>
                                        <tr>
                                            <td>Total Hours:</td>
                                        ...
                                        <tr>
                                            <td>Created:</td>
                                            <td class="text-right"><?php echo  htmlentities($row->Start_date);?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Deadline:</td>
                                            <td class="text-right"><?php echo  htmlentities($row->Deadline);?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Priority:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><a
                                                    href="profile.php"><?php echo  htmlentities($row->leader_1);?></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Status:</td>
                                ...
                                <ul class="list-box">
                                    <li>
                                        <a href="profile.php">
                                            <div class="list-item">
                                                <div class="list-left">
                                                    <span class="avatar"><img alt="picture"
                                                            src="img_projects/<?php echo  htmlentities($row->leader_1p);?>"></span>
                                                </div>
                                                <div class="list-body">
                                                    <span
                                                        class="message-author"><?php echo  htmlentities($row->leader_1);?></span>
                                    ...
                                    <li>
                                        <a href="profile.php">
                                            <div class="list-item">
                                                <div class="list-left">
                                                    <span class="avatar"><img alt="picture"
                                                            src="img_projects/<?php echo  htmlentities($row->Team_1p);?>"></span>
                                                </div>
                                                <div class="list-body">
                                                    <span
                                                        class="message-author"><?php echo  htmlentities($row->Team_1);?></span>
                                                    <div class="clearfix"></div>
                                                    <span class="message-content">Team Leader</span>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <h6 class="card-title m-b-20">
                                    ...
                                    <button type="button" class="float-right btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#assign_user"><i class="fa fa-plus"></i> Add</button>
                                </h6>
                                <ul class="list-box">
                                    <li>
                                        <a href="profile.php">
                                            <div class="list-item">
                                                <div class="list-left">
                                                    <span class="avatar"><img alt="picture"
                                                            src="img_projects/<?php echo  htmlentities($row->Team_2p);?>"></span>
                                                </div>
                                                <div class="list-body">
                                                    <span
                                                        class="message-author"><?php echo  htmlentities($row->Team_2);?></span>
                                                    <div class="clearfix"></div>
                                    ...
                                    <li>
                                        <a href="profile.php">
                                            <div class="list-item">
                                                <div class="list-left">
                                                    <span class="avatar"><img alt="picture"
                                                            src="img_projects/<?php echo  htmlentities($row->Team_3p);?>"></span>
                                                </div>
                                                <div class="list-body">
                                                    <span
                                                        class="message-author"><?php echo  htmlentities($row->Team_3);?></span>
                                                    <div class="clearfix"></div>
                                                    <span class="message-content">Web Developer</span>
                                                </div>
                                            </div>
                                ...
                                <ul class="chat-user-list">
                                        ...
                                        <a href="#">
                                            <div class="media">
                                                <span class="avatar"><img alt=""
                                                        src="assets/img/profiles/avatar sukarna.svg"></span>
                                                <div class="media-body align-self-center text-nowrap">
                                                    <div class="user-name">Sukarna</div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="media">
                                                <span class="avatar"><img alt=""
                                                        src="assets/img/profiles/avatar abhimanyu.svg"></span>
                                                <div class="media-body align-self-center text-nowrap">
                                                    <div class="user-name">Abhimanyu</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Client</label>
                                            <select class="select">
                                                <option>Jai Technologies</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="project-members">
                                                <a class="avatar" href="#" data-toggle="tooltip" title="Arjun">
                                                    <img alt="" src="assets/img/profiles/avatar arjun.svg">
                                                </a>
                                                <a class="avatar" href="#" data-toggle="tooltip" title="Sukarna">
                                                    <img alt="" src="assets/img/profiles/avatar sukarna.svg">
                                                </a>
                                                <a class="avatar" href="#" data-toggle="tooltip" title="Abhimanyu">
                                                    <img alt="" src="assets/img/profiles/avatar abhimanyu.svg">
                                                </a>
                                                <a class="avatar" href="#" data-toggle="tooltip" title="Nakula">
