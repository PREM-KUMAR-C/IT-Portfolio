...
<html lang="en">
    ...
    <body>
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><img src="./assets/img/images/projects.svg" alt="projects" width="60" height="54"></span>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><img src="./assets/img/images/team.svg" alt="projects" width="40" height="50"></span>
									<div class="dash-widget-info">
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><img src="./assets/img/images/tasks.svg" alt="projects" width="38" height="50"></span>
									<div class="dash-widget-info">
										<h3>37</h3>
										<span>Tasks</span>
									</div>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><img src="./assets/img/images/employee.svg" alt="projects" width="42" height="50"></span>
									<div class="dash-widget-info">
										<h3>218</h3>
										<span>Employees</span>
									</div>
							...
							<div class="card-group m-b-30">
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex justify-content-between mb-3">
											<div>
												<span class="d-block">Profits</span>
											</div>
											<div>
												<span class="text-success">+6.3%</span>
											</div>
										</div>
										<h3 class="mb-3">₹1,52,300</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">Previous Month <span class="text-muted">₹1,20,982</span></p>
									</div>
								</div>
							</div>
						</div>	
		...
		<div class="footer-bottom" >
			<div class="container">
				<img src="./assets/img/mirks.png" alt="mirks png" class="mirks-img" style=" max-width: 355px;padding: 20px 0 0 0;width: 100%;margin: auto;margin-bottom: 15px;">
				<p class="copyright">
				copyright &copy;<a href="#">Shākthi</a> all rights reserved.<br>Designed and Developed By Shākthi Prakash C&reg;<br>
				</p>
			</div>
    	</div>
		</center>
