...
<html lang="en">
    <head>
        ...
        <title>Invoice Settings - Portfolio admin</title>
						...
						<div class="col-md-8 offset-md-2">
							...
							<form method="POST" enctype="multipart/form-data">
								...
								<div class="form-group row">
									...
									<div class="col-lg-2">
										<div class="img-thumbnail float-right"><img src="./assets/img/logo 3.svg" alt="client profile" class="img-fluid" alt="" width="200" height="60"></div>
									</div>
								</div>
