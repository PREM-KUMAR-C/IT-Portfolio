    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="termin_add.php">
                    <div class="form-group">
                        <label>Terminating Employee <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <input name="Termin_type" required class="form-control" type="text">
                    </div>
                    <div class="form-group">
                        <label>Termination Date <span class="text-danger">*</span></label>
                        <input name="Termin_date" required class="form-control" type="date">
                    </div>
                    <div class="form-group">
                ...
                <div class="container-fluid">
                    <form method="POST" action="termin_edit.php">
                        ...
                        <div class="form-group">
                            <label>Termination Date <span class="text-danger">*</span></label>
                            <input name="Termin_date" required class="form-control" type="date"
                                value="<?php echo $row['Termin_date']; ?>">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal"> Cancel</button>
...
<div class="modal custom-modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Delete Termination</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"> Cancel</button>
                <a href="termin_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"> Yes</a>
            </div>
        </div>
    </div>
</div>