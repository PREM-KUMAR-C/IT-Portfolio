...
<?php
	...
	$sql="select * from employees where id=:invid";
...
<head>
    ...
    <title>Employee Profile - Portfolio admin</title>
                                ...
                                <div class="profile-view">
                                    <div class="profile-img-wrap">
                                        <div class="profile-img">
                                            <a href="#"><img alt="picture"
                                                    src="img_employees/<?php echo  htmlentities($row->Picture);?>"></a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    <h3 class="user-name m-t-0 mb-0">
                                                        ...
                                                        <?php echo  htmlentities($row->LastName);?></h3>
                                                    <h6 class="text-muted">
                                                        <?php echo  htmlentities($row->Designation);?>
                                                    </h6>
                                                    <small
                                                        class="text-muted"><?php echo  htmlentities($row->Department);?>Web
                                                        Designer</small>
                                                    <div class="staff-id">Employee ID :
                                                        <?php echo  htmlentities($row->Employee_Id);?></div>
                                                    <div class="small doj text-muted">Date of Join :
                                                        <?php echo  htmlentities($row->DateTime);?></div>
                                                    <div class="staff-msg"><a class="btn btn-custom"
                                                            href="chat.php">Send Message</a></div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <ul class="personal-info">
                                                    <li>
                                                        ...
                                                        <div class="text"><a
                                                                href=""><?php echo  htmlentities($row->Phone);?></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="title">Email:</div>
                                                        <div class="text"><a
                                                                href=""><?php echo  htmlentities($row->Email);?></a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="title">Birthday:</div>
                                                        <div class="text">20th June</div>
                                                    </li>
                                                    <li>
                                                        <div class="title">Address:</div>
                                                        <div class="text">1861, Mumba Devi Temple Road, Kalbadevi,
                                                            Mumbai, MH 400003</div>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <div class="avatar-box">
                                                                <div class="avatar avatar-xs">
                                                                    <img src="assets/img/profiles/avatar bhima.svg"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                            <a href="profile.php">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="personal-info">
                                            ...
                                            <li>
                                                ...
                                                <div class="text">31 Dec 2030</div>
                                            </li>
                                            <li>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="experience-content">
                                                        <div class="timeline-content">
                                                            <a href="#/" class="name">Indian School of Arts and Sciences
                                                                (UG)</a>
                                                            <div>Bsc Computer Science</div>
                                                            <span class="time">2007 - 2010</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="experience-content">
                                                        <div class="timeline-content">
                                                            <a href="#/" class="name">Indian School of Arts and Science
                                                                (PG)</a>
                                        ...
                                        <div class="experience-box">
                                            <ul class="experience-list">
                                                <li>
                                                    ...
                                                    <div class="experience-content">
                                                        <div class="timeline-content">
                                                            <a href="#/" class="name">Web Designer at Srijai
                                                                Corporation</a>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="experience-content">
                                                        <div class="timeline-content">
                                                            <a href="#/" class="name">Web Designer at Sanjay
                                                                Ronn-tech</a>
                                                            <span class="time">June 2013 - Present (5 years 2
                                                                months)</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="experience-content">
                                                        <div class="timeline-content">
                                                            <a href="#/" class="name">Web Designer at Vijay
                                                                Technology</a>
                                                            <span class="time">June 2013 - Present (5 years 2
                                                                months)</span>
                                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="project-members m-b-15">
                                            ...
                                            <ul class="team-members">
                                                <li>
                                                    <a href="#" data-toggle="tooltip" title="Bhima"><img alt=""
                                                            src="assets/img/profiles/avatar bhima.svg"></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="project-members m-b-15">
                                            ...
                                            <ul class="team-members">
                                                <li>
                                                    <a href="#" data-toggle="tooltip" title="Arjun"><img alt=""
                                                            src="assets/img/profiles/avatar arjun.svg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" data-toggle="tooltip" title="Sukarna"><img alt=""
                                                            src="assets/img/profiles/avatar sukarna.svg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" data-toggle="tooltip" title="Abhimanyu"><img alt=""
                                                            src="assets/img/profiles/avatar abhimanyu.svg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" data-toggle="tooltip" title="Nakula"><img alt=""
                            ...
                            <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="project-title"><a href="project-view.php">Hospital Administration</a>
                                        </h4>
                                        <small class="block text-ellipsis m-b-15">
                            ...
                            <form>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="profile-img-wrap edit-img">
                                            <img class="inline-block" src="assets/img/profiles/avatar arjun.svg"
                                                alt="user">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" class="form-control" value="4487 Temple Street">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="4000001">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select">
                                                <option>-</option>
                                                <option>Narasimhadev</option>
                                                <option>Ananga Pala</option>
                                                <option>Bhima</option>
                                            </select>
                                        </div>
                                    </div>
