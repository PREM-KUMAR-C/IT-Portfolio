...
<head>
    ...
    <title>Designations - Portfolio admin</title>
...
<body>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            <a href="#addnew" data-toggle="modal" class="btn add-btn"><span
                                    class="glyphicon glyphicon-plus"></span>+ Add Designation</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                        ...
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped custom-table datatable">
                                ...
                                <tbody>
                                    ...
                                    <?php include('designation_add_edit_delete_modal.php'); $cnt=$cnt+1;
    ...
    <?php include('designation_add_edit_delete_modal.php') ?>
    </div>
    <!-- /Page Content -->
