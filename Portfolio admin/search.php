...
<html lang="en">
    <head>
        ...
        <title>Search Results - Portfolio admin</title>
														...
														<div class="card-body">
															...
															<div class="project-members m-b-15">
																...
																<ul class="team-members">
																	<li>
																		<a href="#" data-toggle="tooltip" title="Bhima"><img alt="" src="assets/img/profiles/avatar bhima.svg"></a>
																	</li>
																</ul>
															</div>
															<div class="project-members m-b-15">
																...
																<ul class="team-members">
																	<li>
																		<a href="#" data-toggle="tooltip" title="Arjun"><img alt="" src="assets/img/profiles/avatar arjun.svg"></a>
																	</li>
																	<li>
																		<a href="#" data-toggle="tooltip" title="Sukarna"><img alt="" src="assets/img/profiles/avatar sukarna.svg"></a>
																	</li>
																	<li>
																		<a href="#" data-toggle="tooltip" title="Abhimanyu"><img alt="" src="assets/img/profiles/avatar abhimanyu.svg"></a>
																	</li>
																	<li>
																		<a href="#" data-toggle="tooltip" title="Nakula"><img alt="" src="assets/img/profiles/avatar nakula.svg"></a>
																	</li>
																	<li class="dropdown avatar-dropdown">
																		...
																		<div class="dropdown-menu dropdown-menu-right">
																			<div class="avatar-group">
																				...
																				<a class="avatar avatar-xs" href="#">
																					<img alt="" src="assets/img/profiles/avatar abhimanyu.svg">
																				</a>
																				<a class="avatar avatar-xs" href="#">
																				...
																				<a class="avatar avatar-xs" href="#">
																					<img alt="" src="assets/img/profiles/avatar bhima.svg">
																				</a>
																			</div>
											...
											<div class="row staff-grid-row">
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Jai Technologies</a></h4>
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Pulakesi</a></h5>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Vijay Infotech</a></h4>
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Prithviraj</a></h5>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Ajay Inc</a></h4>
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Lachit</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Srijay Company</a></h4>
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Samyukta Devi</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Indhumati Technologies</a></h4>
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Vishwanath</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Indian Software Inc</a></h4>
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Harsha Vardhana</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Lakshmi Software Inc</a></h4>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Divya Technologies</a></h4>
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Vidhyadhara</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<table class="table table-striped custom-table">
													...
													<tbody>
														<tr>
															<td>
																<h2 class="table-avatar">
																	...
																	<a href="profile.php">Prakash <span>Admin</span></a>
																</h2>
															</td>
															<td>prakash@example.com</td>
															<td>Shakthi Technologies</td>
															<td>1 Jan 2013</td>
															<td>
														...
														<tr>
															<td>
																<h2 class="table-avatar">
																	<a href="profile.php" class="avatar"><img alt="" src="assets/img/profiles/avatar arjun.svg"></a>
																	<a href="profile.php">Arjun <span>Web Designer</span></a>
																</h2>
															</td>
														...
														<tr>
															<td>
																<h2 class="table-avatar">
																	<a href="profile.php" class="avatar"><img alt="" src="assets/img/profiles/avatar sukarna.svg"></a>
																	<a href="profile.php">Sukarna <span>Admin</span></a>
																</h2>
															</td>
															<td>sukarna@example.com</td>
															<td>Shakthi Technologies</td>
															<td>1 Jan 2013</td>
															<td>
																<span class="badge bg-inverse-success">Employee</span>
														...
														<tr>
															<td>
																<h2 class="table-avatar">
																	<a href="profile.php" class="avatar"><img alt="" src="assets/img/profiles/avatar abhimanyu.svg"></a>
																	<a href="profile.php">Abhimanyu <span>Android Developer</span></a>
																</h2>
															</td>
															<td>abhimanyu@example.com</td>
															<td>Shakthi Technologies</td>
															<td>1 Jan 2013</td>
															<td>
																<span class="badge bg-inverse-success">Employee</span>
														...
														<tr>
															<td>
																<h2 class="table-avatar">
																	<a href="profile.php" class="avatar"><img alt="" src="assets/img/profiles/avatar nakula.svg"></a>
																	<a href="profile.php">Nakula <span>IOS Developer</span></a>
																</h2>
															</td>
															<td>nakula@example.com</td>
															<td>Shakthi Technologies</td>
															<td>1 Jan 2013</td>
															<td>
																<span class="badge bg-inverse-success">Employee</span>
														...
														<tr>
															<td>
																<h2 class="table-avatar">
																	...
																	<a href="profile.php">Narasimha Dev <span>Team Leader</span></a>
																</h2>
															</td>
														...
														<tr>
															<td>
																<h2 class="table-avatar">
																	...
																	<a href="profile.php">Pulakesi <span>Jai Technologies</span></a>
																</h2>
															</td>
															<td>pulakesi@example.com</td>
															<td>Jai Technologies</td>
															<td>1 Jan 2013</td>
															<td>
